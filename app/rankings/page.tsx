                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="md:col-span-2 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-zinc-900/50 border border-zinc-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all text-white placeholder:text-zinc-500"
                            />
                        </div>
